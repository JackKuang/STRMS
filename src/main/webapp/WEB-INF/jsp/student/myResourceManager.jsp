		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb" id="path">
					<li id="-1"><i class="fa fa-user">所有教师</i> </li>
				</ol>
			</div>
			<div class="col-md-12" id="teacherTableDiv">
				<div class="box">
					<div class="box-body">
...
<script type="text/javascript">
	...
	function initTableTeacher(){
        ...
        $("#teacherTable").bootstrapTable({  
            ...
            url:"../resource/resource!pageTeacherForStudent.action", 
            //url:"/STRMS/test.json",
            striped: true,  //表格显示条纹  
            ...
            onDblClickCell:function(field, value, row){
				addPathTea(row.teaId,row.teaName);
				resTeaId = row.teaId;
	...
	function addPathTea(id,name){
        //<li id="0"><a href="#" onclick="reloadByPath(this)"><i class="fa fa-home"></i> Home</a></li>
        var oldPath = $("#path li:last-child").html();
        var newPath = '<a href="#" onclick="toTeaList()">' + oldPath + '</a>';
        $("#path li:last-child").html(newPath);
        $("#path").append('<li id="0">'+name+'</li>');
		$("#previewDiv").hide();
		$("#previewOperateDiv").hide();
	}
	
	function toTeaList(){
		$("#path").html('<li id="-1"><i class="fa fa-user">所有教师</i> </li>');
	    $("#tableDiv").hide();
