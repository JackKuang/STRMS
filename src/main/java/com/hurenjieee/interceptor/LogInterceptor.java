    ...
    public String intercept(ActionInvocation invocation) throws Exception{
        ...
        invocation.addPreResultListener(new PreResultListener() {
            ...
            public void beforeResult(ActionInvocation invocation,String resultCode){
                ...
                String name = (String) sessionMap.get("userType");
                if (name != null) {
                    sb.append("[" + name + "]");
                } else {
                    sb.append("[anonymous]");
                ...
                // 2016-11-30 10:34:16 [INFO]
                // -[anonymous]visited[LoginAction.login]with{login==>[提交]passWord==>[123]userName==>[admin]}result==>[success]
                log.info(sb);
            }
        });
